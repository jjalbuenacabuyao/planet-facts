...
const PlanetImage = () => {
  ...
  const { images } = planet;
  return (
    <div className="relative grid place-items-center py-20 md:col-span-2 md:row-start-1 md:py-32 lg:row-span-2 lg:row-start-1">
      <Image
        src={activeTab === "Internal" ? images.internal : images.planet}
        alt=""
        width={150}
        height={150}
        className={`aspect-square w-40 md:w-64`}
      />
      {activeTab === "Surface" && (
        <Image
          src={images.geology}
